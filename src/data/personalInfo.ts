/**
 * Informações pessoais do portfólio
 */
...
export const personalInfo = {
  ...
  socialLinks: {
    linkedin: 'https://www.linkedin.com/in/natanael-figueredo-balbo',
    github: 'https://github.com/natanaelbalbo',
  },

  summary: `Graduando em Engenharia de Software pela Unicesumar e Engenheiro Front-End formado pela EBAC
    ...
    com foco na construção de soluções robustas, funcionais e escaláveis.`,

  bio: `Desenvolvedor Full Stack e Engenheiro Front-End formado pela EBAC, apaixonado por criar
    soluções escaláveis e funcionais. Atualmente trabalhando na ROQT Data & IA, desenvolvendo
    sistemas ERP e aplicações web com tecnologias modernas como React, TypeScript, Django e Docker.`,
};
